    ...
    return (
        <div className = "fixed top-0 right-0 left-0 z-50 w-full bg-white h-16 shadow-md">
            <div className = "flex justify-between h-full mx-auto"> 
                <div className="flex">
                    <div className = "flex items-center text-2xl font-black w-40 text-center px-5 bg-birumuda text-white">SembApp</div>
                ...
                <div className = "flex text-base text-center items-center">
                    <button className = "px-2 py-7"><img src={notifikasi}/></button>
                    <button className = "px-2 py-7"><img src={help}/></button>
                    <button className = "px-2 py-7"><img src={pengaturan}/></button>
                    <button className = "px-8 py-7"><img className="" src={avatar}/></button>
                </div>
            </div>
        </div>
